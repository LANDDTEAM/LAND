...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./LAND.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("LD", "w")  
...
sudo_users = {SUDO,1124341247,1313703081}   
...
if hash or SudoBot(msg) or DevLANDW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevLANDW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLANDW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "LAND_TEAM")
...
LAND_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
LAND_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
LAND_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
LAND_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceLAND(msg,data) -- بداية العمل
if msg then
...
if not DevLANDW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevLANDW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,LAND_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'✯┇  عدد الكروبات الان » { '..#group..' }'..LANDk..''..LAND..'\n✯┇  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevLANDW(msg) then
...
usertext = '\n ✯┇ العضو » ['..result.title_..'](t.me/'..(username or 'LAND_TEAM')..')'
status  = '\n ✯┇ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevLANDW(msg) then
...
usertext = '\n ✯┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LAND_TEAM')..')'
status  = '\n ✯┇ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevLANDW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevLANDW(msg) then
...
local LAND1_Msg = database:get(bot_id.."LAND1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LAND1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯┇ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'LAND_TEAM')..') \n ✯┇ '..LAND1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if LAND_Msg and not Special(msg) then  
local LAND_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LAND_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯┇ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✯┇ ["..LAND_Msg.."] \n")
else
send(msg.chat_id_,0," ✯┇ العضو : {["..data.first_name_.."](T.ME/LAND_TEAM)}\n ✯┇ ["..LAND_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯┇ عذرا » {["..data.first_name_.."](T.ME/LAND_TEAM)}\n ✯┇ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLANDW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevLANDW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevLANDW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✯┇ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevLANDW(msg) then  
...
database:sadd(bot_id.."LAND:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."LAND:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_LAND = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_LAND then 
names_LAND = database:smembers(bot_id.."LAND:blocname"..msg.chat_id_) or ""
if names_LAND and names_LAND[1] then 
for i=1,#names_LAND do 
if name_LAND:match("(.*)("..names_LAND[i]..")(.*)") then 
...
database:set(bot_id.."LAND:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."LAND:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."LAND:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."LAND:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."LAND:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_LANDa_new(LAND1,LAND2)
if LAND2 and LAND2.first_name_ then 
if LAND2.first_name_:match("(.*)"..database:get(bot_id.."LAND:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LAND:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local LAND_nnn = database:get(bot_id.."LAND:nump"..msg.chat_id_) or 5
local LAND_nnn2 = database:get(bot_id.."LAND:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(LAND_nnn2) == tonumber(LAND_nnn) or tonumber(LAND_nnn2) > tonumber(LAND_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."LAND:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯┇ عزيزي >>["..LAND2.username_.."](https://t.me/"..(LAND2.username_ or "LAND_TEAM")..")\n✯┇ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."LAND:teh"..msg.chat_id_).."} بجانب اسمك\n✯┇ عدد المحاولات المتبقيه {"..(tonumber(LAND_nnn) - tonumber(LAND_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_LANDa_new)
end
end
...
local LANDChengName = database:get(bot_id.."LAND:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LANDChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LANDChengName..']')
database:del(bot_id.."LAND:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LANDChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."LAND:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LANDChengUserName = database:get(bot_id.."LAND:Cheng:UserName"..data.id_)
if not data.username_ then 
if LANDChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LANDChengUserName..']')
database:del(bot_id.."LAND:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LANDChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."LAND:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LANDChengPhoto = database:get(bot_id.."LAND:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LANDChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."LAND:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if LANDChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."LAND:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
🌐┇LAND TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
[📊┇ Source Channel]http://t.me/LAND_TEAM

[📁┇ Source  Files](http://t.me/LAND_DEV)

[⚙️┇ Tumblr Channel])(http://t.me/KASPEAR)
...
if text == 'رفع نسخه الاحتياطيه' and DevLANDW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✯┇ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'LAND_TEAM')..') \n ✯┇ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯┇ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'LAND_TEAM')..') \n ✯┇ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevLANDW(msg) then    
dofile('LAND.lua')  
send(msg.chat_id_, msg.id_, ' ✯┇ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevLANDW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevLANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevLANDW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevLANDW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevLANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevLANDW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevLANDW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevLANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevLANDW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevLANDW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevLANDW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevLANDW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevLANDW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "LAND_TEAM")
...
function Function_LAND(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_LAND, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_LAND, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯┇ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LAND_TEAM')..')'
status  = '\n ✯┇ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✯┇ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✯┇ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LAND_TEAM')..')'
...
database:set(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✯┇ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✯┇ تم منع الكلمه مع التحذير")  
database:del(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LAND1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LAND1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✯┇ ارسل الكلمه الان")  
database:set(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LAND1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LAND1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."LAND1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LAND1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LAND1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LAND1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✯┇ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local LAND_Msg = database:get(bot_id.."LAND1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..LAND_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevLANDW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✯┇ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevLANDW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✯┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'LAND_TEAM')..')'..'\n ✯┇ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevLANDW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevLANDW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..LAND_Msg[math.random(#LAND_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevLANDW(msg) then 
...
if text == ("مسح ردود المطور") and DevLANDW(msg) then 
...
if text == ("ردود المطور") and DevLANDW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✯┇ قائمة ردود المطور \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'لاند').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevLANDW(msg) then   
...
if text == 'تعطيل المغادره' and DevLANDW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LAND')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'LAND_TEAM')..')'
local iduser = result.sender_user_id_
...
if text == 'استعاده الاوامر' and DevLANDW(msg) then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'لاند')
...
LAND = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(LAND)
...
------------------------------------------------------------------------
local LANDAbot = database:get(bot_id.."LAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if LANDAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯┇ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✯┇ ["..LANDAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local LAND1_Msg = database:get(bot_id.."LAND1:Add:Filter:Rp2"..text..result.chat_id_)   
if LAND1_Msg then    
send(msg.chat_id_, msg.id_," ✯┇ "..LAND1_Msg)
